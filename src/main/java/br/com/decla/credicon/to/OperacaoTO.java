...
public class OperacaoTO {
	...
	private String dataContratacao; //Tipo A - Tamanho 8 - Decimais  # Posição 99-106 #Data de contratação da operação.
	private String dataVencimento; //Tipo A - Tamanho 8 - Decimais  # Posição 107-114 #Data de pagamento da última parcela ou de expiração do contrato. Quando não informado indica data de vencimento indeterminada (Formato AAAA-MM-DD) no intervalo > 31/12/1900 e < 01/01/2050
